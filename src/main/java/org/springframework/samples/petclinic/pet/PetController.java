...
class PetController {
	...
	public Collection<String> populateGender() {
		return Arrays.stream(Gender.values()).map(Enum::name).collect(Collectors.toList());
	}

	@ModelAttribute("owner")
	public Owner findOwner(@PathVariable("ownerId") int ownerId) {
		Optional<Owner> optionalOwner = petService.findById(ownerId);
	...
	public String processUpdateForm(Owner owner, @Valid Pet pet, BindingResult result,
		...
		petService.updatePetDetails(owner, pet);
